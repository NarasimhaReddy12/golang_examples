...
/*
Package grpc_customer is a reverse proxy.
...
func request_Customer_GetCustomers_0(ctx context.Context, marshaler runtime.Marshaler, client CustomerClient, req *http.Request, pathParams map[string]string) (Customer_GetCustomersClient, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Customer_GetCustomers_0); err != nil {
...
var (
	pattern_Customer_GetCustomers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "customer", "get"}, ""))

	pattern_Customer_CreateCustomer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "customer", "create"}, ""))
)
